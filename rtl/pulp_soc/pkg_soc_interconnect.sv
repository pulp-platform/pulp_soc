package pkg_soc_interconnect;
    ...
    localparam int unsigned NR_SDMA_TCDM_MASTER_PORTS = 4; //  4 ports for 64-bit axi port
    ...
    localparam int unsigned NR_TCDM_MASTER_PORTS = NR_SOC_TCDM_MASTER_PORTS + NR_SDMA_TCDM_MASTER_PORTS + NR_CLUSTER_2_SOC_TCDM_MASTER_PORTS + NR_PERIPH_2_SOC_TCDM_MASTER_PORTS;
